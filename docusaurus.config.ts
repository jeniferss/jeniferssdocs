...
const config: Config = {
  ...
  url: 'https://jeniferss.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/jeniferssdocs/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'jeniferss', // Usually your GitHub org/user name.
  projectName: 'jeniferssdocs', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      style: 'dark',
      links: [],
      copyright: `Copyright © ${new Date().getFullYear()} Jenifer S Souza. Built with Docusaurus.`,
    },
    prism: {
